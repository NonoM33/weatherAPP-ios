...
extension UIFont {
    enum R {
        ...
        static var body3 = UIFont.systemFont(ofSize: 16, weight: .heavy)
        static var body4 = UIFont.systemFont(ofSize: 24, weight: .regular)
        static var title1 = UIFont.systemFont(ofSize: 16, weight: .bold)
        static var title2 = UIFont.systemFont(ofSize: 36, weight: .bold)
        static var title3 = UIFont.systemFont(ofSize: 40, weight: .bold)
